...
import 'dart:async';
import 'package:fit_friend_tracker_proyecto_final/drawerPage.dart';
...
class ActivityData {
  ...
  static void addActivity(int pasos, double km, int minutos) {
    ...
    print('Pasos: $pasos, Kilómetros: ${km.toStringAsFixed(2)}, Minutos: $minutos');
    print('Totales Acumulados: Pasos: $finalPasos, KM: ${finalKilometros.toStringAsFixed(2)}');
  }
...
// VARIABLES DEL TEMPORIZADOR
  ...
  Widget build(BuildContext context) {
    ...
    String secDisplay = (_activityTimer != null && _activityTimer!.isActive && !isPaused)
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                  ...
                  color: countdown > 0 ? Colors.orange : (isPaused ? Colors.red : Colors.green)),
            ),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text("Reanudar", style: TextStyle(color: Colors.white)),
                  style: ElevatedButton.styleFrom(
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text("Terminar", style: TextStyle(
                      color: Colors.white
                  )),
                  style: ElevatedButton.styleFrom(
